...
import {InvestmentFilterRequest, InvestmentRecord, InvestmentStatus,} from '../../models/investment-package.model';
import {PageResponse} from '../../../../shared/models/api-response.model';
import {TabItem} from "../../../../shared/tabs/models/tab-item.model";

@Component({
  selector: 'app-investment-package-investment-list',
  standalone: false,
  templateUrl: './investment-package-investment-list.component.html',
  styleUrl: './investment-package-investment-list.component.css',
})
export class InvestmentPackageInvestmentListComponent implements OnInit {
  ...
  loadInvestments(): void {
    ...
    this.investmentPackageService.filterInvestments(request).subscribe({
  ...
  handleSendConfirmation() {
    ...
    this.investmentPackageService.send(this.selectedInvestment.id).subscribe({
      next: () => {
        this.lockSend = false;
  ...
  handleCancelConfirmation() {
    ...
    this.investmentPackageService.cancel(this.selectedInvestment.id).subscribe({
      next: () => {
        this.lockCancel = false;
