...
@Component({
  selector: 'app-investment-package-investment-view',
  standalone: true,
  ...
  templateUrl: './investment-package-investment-view.component.html',
  styleUrl: './investment-package-investment-view.component.css',
})
export class InvestmentPackageInvestmentViewComponent implements OnChanges {
