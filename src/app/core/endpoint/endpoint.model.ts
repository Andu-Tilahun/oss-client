...
export const Endpoints = {
  ...
  CLEARING_AGENT_APPLICANTS_ENDPOINT: '/license/clearing-agent-applicants',
  USER_REQUESTS_ENDPOINT: '/license/user-requests',
  WORKFLOWS_ENDPOINT: '/license/workflows',
  SUBCITIES_ENDPOINT: '/license/subcities',
  WOREDAS_ENDPOINT: '/license/woredas',
  SERVICE_FEES_ENDPOINT: '/license/service-fees',
  ...
  DEPARTMENTS_ENDPOINT: '/inventory/departments',
  ITEM_TYPES_ENDPOINT: '/inventory/item-types',
  ITEMS_ENDPOINT: '/inventory/items',
  BORROW_RECORDS_ENDPOINT: '/inventory/borrow-records',
